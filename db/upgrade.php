...
/**
 * Auth lmsace connect - Upgradtion process, add auth external functions into lmsace connect service functions.
 *
...
/**
  ...
  * @return bool
  */
function xmldb_auth_lmsace_connect_upgrade( $oldversion ) {
